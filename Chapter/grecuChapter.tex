...
the GPM combined algorithm \cite{grecu2016} is available in netCDF format at:
...
Shown in figure \ref{fig:dataEx} is an example of DPR observed reflectivity and two of the associated brightness for a portion of
orbit 5866 over the Kwajelein atoll. As apparent in the figure, at reflectivity observations tend to be significantly attenuated 
...
estimates.  Such estimates are especially useful when the SRT PIA are unreliable and may be used in the estimation process along with SRT PIAs,
because the optimal estimation theory can effectively incorporate information from multiple sources as long as their uncertainties are 
properly specified.
