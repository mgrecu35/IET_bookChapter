...
Shown in Fig. \ref{fig:ML_PIA} is differential PIA from the ML model described in the previous section along with 
...
nor brightnes temperature based PIA estimates are reliable due to the saturation effects.  That is observations involved
...
to have distributions signficantly more complex than a normal distribution. The Hitchfeld-Bordan approach results in a 
a distribution of estimates because any specific assumption regarding the PSD intercept $N_w$ results in particular PIA
precipitation profile estimates.
